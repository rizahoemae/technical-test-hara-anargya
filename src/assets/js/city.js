...
import { findByIdProv } from './province';

export const findByProv = (id) => {
  return city.filter((data) => data.provinsi_id == id);
};

// export const findById = (id) => {
//   const data = city.find((data) => data.id == id);
//   return findByIdProv(data.id);
// };
export default city;
